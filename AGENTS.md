# AGENTS.md — Soni Films

Premium cinematic website for **Soni Films** (Delhi-based creative production house). Built with TanStack Start and deployed on Netlify.

## Project Overview

Single-page marketing/portfolio site. All visible content lives in `src/routes/index.tsx`. No database, no authentication, no AI features. The contact form uses Netlify Forms.
