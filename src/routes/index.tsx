...
function SoniFilmsHome() {
  return (
    <div style={{ background: '#0a0a0a', minHeight: '100vh' }}> <a
...
>
  <svg
    ...
    fill="white"
  >
    <path d="M20.52 3.48A11.82 11.82 0 0012.06 0C5.5 0 .16 5.34.16 11.9c0 2.1.55 4.15 1.6 5.96L0 24l6.3-1.65a11.84 11.84 0 005.76 1.47h.01c6.56 0 11.9-5.34 11.9-11.9 0-3.18-1.24-6.16-3.45-8.44zM12.07 21.8a9.8 9.8 0 01-5-1.37l-.36-.21-3.74.98 1-3.64-.23-.38a9.82 9.82 0 01-1.5-5.28c0-5.42 4.41-9.83 9.83-9.83 2.62 0 5.08 1.02 6.93 2.88a9.75 9.75 0 012.88 6.95c0 5.42-4.41 9.82-9.81 9.82zm5.39-7.35c-.29-.15-1.72-.85-1.99-.95-.27-.1-.47-.15-.66.15-.2.29-.76.95-.93 1.14-.17.2-.34.22-.63.07-.29-.15-1.22-.45-2.33-1.43-.86-.77-1.44-1.72-1.61-2.01-.17-.29-.02-.45.13-.6.13-.13.29-.34.44-.51.15-.17.2-.29.29-.49.1-.2.05-.37-.02-.52-.07-.15-.66-1.59-.91-2.18-.24-.58-.49-.5-.66-.51h-.56c-.2 0-.52.07-.79.37-.27.29-1.03 1.01-1.03 2.47s1.05 2.87 1.19 3.07c.15.2 2.06 3.15 5 4.41.7.3 1.25.48 1.68.61.71.23 1.36.2 1.87.12.57-.08 1.72-.7 1.97-1.38.24-.68.24-1.26.17-1.38-.07-.12-.27-.2-.56-.34z"/>
  </svg>
</a>
      <Navbar />
      <HeroSection />
